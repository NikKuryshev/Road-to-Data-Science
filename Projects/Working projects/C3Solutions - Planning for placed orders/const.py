...
categories = {
	...
	'ИБП': ups,
	'Батарейные шкафы/модули': battery,
	'АВР': ats,
	'Лотки': tray,
	'Изоляция': aisle,
